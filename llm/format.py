...
- You may organise the documented observations under the selected template's
  headings and derive an impression only from those documented observations,
  but do not invent completeness, pathology, normality or recommendations.
